...
STOCK_SECTORS = {
    ...
    "NOW": "technology", "SNPS": "technology", "PANW": "technology",
    "PLTR": "technology", "CRWD": "technology",
    # Semiconductors
    "NVDA": "semiconductor", "AMD": "semiconductor", "AVGO": "semiconductor",
    "QCOM": "semiconductor", "MRVL": "semiconductor", "ANET": "semiconductor",
    # Consumer
    "AMZN": "consumer", "TSLA": "consumer", "NFLX": "consumer",
    "COST": "consumer", "HD": "consumer", "NKE": "consumer",
    "SBUX": "consumer", "UBER": "consumer",
    # Financials
    "GS": "financials", "JPM": "financials", "V": "financials",
    "MA": "financials", "COIN": "financials",
    # Healthcare
    "LLY": "healthcare", "UNH": "healthcare", "ISRG": "healthcare",
    "ABBV": "healthcare",
    # Industrials
...
def get_exposure_group(intent: TradeIntent) -> set[str]:
    ...
    elif intent.instrument_type == "futures":
        return {f"futures_{intent.symbol}"}
    return set()
...
def score_opportunity(
    ...
    if intent.is_forex:
        ...
        # Futures: use price distances (same as stocks)
        if intent.direction == "BUY":
